...
1. **A Comparative Study on Generative Models for High Resolution Solar Observation Imaging**  
   ...
   *arXiv preprint arXiv:2304.07169 [cs.CV]*, 2023.  
   Presented at the *2nd ICML Workshop on Machine Learning for Astrophysics* (2023).  
   Links: [[arXiv](https://arxiv.org/abs/2304.07169)] [[ICML Workshop](https://icml.cc/virtual/2023/workshop/21497)]

   <details style="margin-top: 0.5em; margin-bottom: 1em; cursor: pointer;">
     <summary style="color: #2a7ae2; font-weight: bold; font-size: 0.9em;">[See Abstract]</summary>
     <div style="margin-top: 0.5em; padding-left: 15px; border-left: 3px solid #ccc; font-style: italic; color: #555;">
...
1. **On the Smoluchowski-Kramers Approximation for global dynamics of the hyperbolic $O(N)$ linear sigma model**  
   ...
   *In preparation*, 2026.
   ...
   <details style="margin-top: 0.5em; margin-bottom: 1em; cursor: pointer;">
     <summary style="color: #2a7ae2; font-weight: bold; font-size: 0.9em;">[See Abstract Description]</summary>
     <div style="margin-top: 0.5em; padding-left: 15px; border-left: 3px solid #ccc; font-style: italic; color: #555;">
...
<details style="margin-top: 0.5em; margin-bottom: 1em; cursor: pointer;">
  <summary style="color: #2a7ae2; font-weight: bold; font-size: 0.9em;">[See Abstract]</summary>
  <div style="margin-top: 0.5em; padding-left: 15px; border-left: 3px solid #ccc; font-style: italic; color: #555;">
    We consider the Smoluchowski Kramers Approximation for the stochastic damped mean field wave equation (SDMFW)
$$\varepsilon^2 \dt^2 u_\varepsilon +  \dt u_\varepsilon + (1 - \Dl) u_\varepsilon  + \E[\wick{u_\varepsilon^2}]u_\varepsilon = \sqrt{2}\xi$$ to the stochastic mean field heat equation (SMFH) $$\dt u_0 + (1 - \Dl) u_0  + \E[\wick{u_0^2}]u_0 = \sqrt{2}\xi$$, with a white-noise forcing term $$\xi$$, posed on the two-dimensional torus $$\T^2$$. The main contributions of this thesis are: (i) We apply the $$I$$-Method to derive a global bound on $$u_\varepsilon$$ that is uniform in $$\varepsilon$$, allowing for the strong global convergence of $$u_\varepsilon$$ to $$u_0$$ as $$\varepsilon \to 0$$. (ii) We establish an argument, utilizing self-adjoint operator theory, to prove that $$\rho_\varepsilon \coloneq \mathcal{N}\left(0, \begin{pmatrix} (1-\Delta)^{-1} & 0 \\ 0 & \varepsilon^{-2} \end{pmatrix}\right) \in \mathcal{P}(H^{-\sigma}(\T^2) \times H^{-1-\sigma}(\T^2))$$ is the unique invariant measure of the SDMFW in the class $$\{\mu \in \mathcal{P}(H^{-\sigma}(\T^2) \times H^{-1-\sigma}(\T^2)) : \EVMU{\wick{u^2}} \in H^{-\sigma}(\T^2) \}$$, where $$\wick{u^2}$$ denotes a Wick renormalization.
(iii) We prove the convergence of $$\rho_\varepsilon$$ to $$\rho_0$$ as $$\varepsilon \to 0$$ using continuous bounded test functions that vanish at infinity, where $$\rho_0 \coloneq \mathcal{N}(0,(1-\Delta)^{-1}) \in \mathcal{P}(H^{-\sigma}(\T^2))$$ is the invariant measure of the SMFH, and discuss why this convergence fails in a weak sense and is trivial in a vague sense.  
  </div>
</details>
